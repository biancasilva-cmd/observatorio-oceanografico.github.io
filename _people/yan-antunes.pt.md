...
title: "Yan Antunes"
lang: pt
permalink: /pessoas/yan-antunes/
alt_lang: /people/yan-antunes/
...
Recentemente entrei em um projeto de iniciação científica, onde estou em processo de capacitação e aprendizado em técnicas de programação, processamento de dados e aplicações voltadas às ciências ambientais. Tenho bastamte interesse em aprender coisas novas, principalmente quando consigo unir teoria e prática. Curto bastante ler e colocar a mão na massa para entender como as coisas funcionam de verdade.

🌎 **Objetivo** 
Construir experiência acadêmica e profissional na integração entre engenharia, tecnologia e meio ambiente, participando de projetos que contribuam para análise e compreensão de problemas ambientais.
